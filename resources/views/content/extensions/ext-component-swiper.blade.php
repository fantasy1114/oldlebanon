      ...
      <div class="swiper-centered-slides-2 swiper-container p-1">
        <div class="swiper-wrapper">
          <div class="swiper-slide rounded swiper-shadow py-1 px-3 d-flex">
            <i data-feather="play" class="mr-50 font-medium-3"></i>
            <div class="swiper-text">Getting Started</div>
          </div>
          <div class="swiper-slide rounded swiper-shadow py-1 px-3 d-flex">
            <i data-feather="dollar-sign" class="mr-50 font-medium-3"></i>
            <div class="swiper-text">Pricing & Plans</div>
          </div>
          <div class="swiper-slide rounded swiper-shadow py-1 px-3 d-flex">
            <i data-feather="help-circle" class="mr-50 font-medium-3"></i>
          ...
          <div class="swiper-slide rounded swiper-shadow py-1 px-3 d-flex">
            <i data-feather="archive" class="mr-50 font-medium-3"></i>
