    ...
    <div class="table-responsive">
      <table class="table">
        ...
        <tbody>
          ...
          <tr>
            <td>
              <img src="{{asset('images/icons/react.svg')}}" class="mr-75" height="20" width="20" alt="React">
              <span class="font-weight-bold">React Project</span>
            </td>
            <td>Ronald Frest</td>
            <td>
          ...
          <tr>
            <td>
              <img src="{{asset('images/icons/vuejs.svg')}}" class="mr-75" height="20" width="20" alt="Vuejs" />
              <span class="font-weight-bold">Vuejs Project</span>
            </td>
            <td>Jack Obes</td>
            <td>
